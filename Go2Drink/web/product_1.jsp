    ...
    <body>
        ...
        <div class="page-container">
            <div class="left">
                ...
                <p><a href="jelly.html" style="text-decoration: none">日本鮮果凍</a></p>
                <p><a href="MENU.html" style="border-bottom-style:solid; 
                      border-bottom-color:#33ff33;text-decoration:none">產品MENU</a></p>			
            </div>
        </div>
        <%
